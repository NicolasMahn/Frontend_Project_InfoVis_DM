...
const LandingPage = () => {
    return (
        <div>
            ...
            <h4>The Graphs</h4>
            <ul>
                <li>Purchases per Location: This Graph shows how many purchases have been made for each location.</li>
                <li>Puchases over Time: This Graph shows how the number of purchases evolves through differnet time categories. 
                    It is possible to see when a specific location is popular Through the week or through a typical day.</li>
                <li>Credit and Loyalty Card Matrix: In this Graph we matched loyalty cards and credit crads to each other based on time and location they were used.</li>
                <li>Cars and Credit Card Matrix: In this Graph we tried to match cars and credit cars based on their location and purchases to each other.</li>
                <li>Location and Emloyee Map: This Map shows clusters of parking cars (color) and points where employees have met minimum 2 times for 10 minutes in the abila street network.</li>
            </ul>
            </section>
            <section>
                <h4>How to use:</h4>
